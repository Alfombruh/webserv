...
echo "CGI Script BASH GET Test Page"
echo "</div>"
...
echo "<body>"
echo "<div style=\"width: 100%; font-size: 40px; font-weight: bold; text-align: center;\">"
echo "CGI Script BASH POST Test Page"
echo "</div>"
echo "<h2> Your body: </h2>"
echo "<h2> $1 </h2>"
echo "</body>"
echo "</html>"
fi
if [ "$REQUEST_METHOD" == "DELETE" ]; then
  ...
  then
	...
	echo "<body>"
	echo "<div style=\"width: 100%; font-size: 40px; font-weight: bold; text-align: center;\">"
	echo "CGI Script BASH DELETE Test Page"
	echo "</div>"
    echo "<h2>Sexadores de pollo al poder<h2>"
	echo "<h2>Joaquin la chupa por kebab<h2>"
    echo "</div>"
    echo "</body>"
    echo "</html>"
  fi
