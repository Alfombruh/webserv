...
/*---------------------------------------top 9---------------------------------------------*/
{
  axios.get('https://www.breakingbadapi.com/api/characters?limit=9&offset=0')
...
{
  axios.get('https://www.breakingbadapi.com/api/quote/random?author=Walter+White')
    .then(function (response) {


      let walterRamndomQuote = response.data[0].quote;
      document.getElementById("walterQuote").innerHTML = '"' + walterRamndomQuote + '"';
  ...
  axios.get('https://www.breakingbadapi.com/api/quote/random?author=Jesse+Pinkman')
    .then(function (response) {


      let jesseRamndomQuote = response.data[0].quote;
      document.getElementById("jesseQuote").innerHTML = '"' + jesseRamndomQuote + '"';
...
function myFunction() {
  ...
  let petition = 'https://www.breakingbadapi.com/api/characters?name=' + userCharacter;
  ...
  axios.get(petition)
    .then(function (response) {
      ...
      newFavButton.addEventListener("click", function () { favorites(response.data[0]) });
